...
def parse_args():
    ...
    parser.add_argument('--critic_iters', type=int, default=5, help='')
    parser.add_argument('--lambda_term', type=int, default=10, help='')
...
def check_args(args):
    ...
    if args.dataset == 'cifar' or args.dataset == 'stl10' or args.dataset == 'terrain':
        args.channels = 3
    else:
        args.channels = 1
